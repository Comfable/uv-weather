var context = new OffscreenCanvas(40, 40);
var start = new Date();
var lines = 16,
  cW = 40,
  cH = 40;
...
function solarNighDay(timeZoneBadge, latlong) {
  ...
  totalSeconds = moment(moment.unix(sunsetTimeSolar)).diff(
    moment(moment.unix(sunriseTimeSolar)),
    "second"
  );
...
function iconBadgeConvertNO(iconNO, nightNO) {
  ...
  if (iconNO == "cloudy") {
    ...
    iconNO == "rainandthunder" ||
    iconNO == "heavyrain" ||
    iconNO == "lightrainshowers" ||
    iconNO == "lightrain" ||
    iconNO == "lightrainshowersandthunder" ||
    iconNO == "lightrainandthunder" ||
    iconNO == "heavyrainshowersandthunder" ||
    iconNO == "lightssnowshowersandthunder" ||
    iconNO == "rainshowersandthunder" ||
    iconNO == "rainshowers" ||
    iconNO == "heavyrainandthunder" ||
    iconNO == "heavyrainshowers" ||
    iconNO == "rain"
  ) {
    iconBadge = "rain";
    rainyBadge = true;
    ...
    iconNO == "snowshowers" ||
    iconNO == "snowandthunder" ||
    iconNO == "heavysnow" ||
    iconNO == "heavysnowshowersandthunder" ||
    iconNO == "snowshowersandthunder" ||
    iconNO == "lightsnow" ||
    iconNO == "lightsnowshowers" ||
    iconNO == "lightsnowandthunder" ||
    iconNO == "snow" ||
    iconNO == "heavysnowshowers" ||
    iconNO == "heavysnowandthunder"
  ) {
    iconBadge = "snow";
    snowyBadge = true;
    chrome.storage.local.set({ snowyBadge: true });
    ...
    iconNO == "lightsleet" ||
    iconNO == "lightsleetshowers" ||
    iconNO == "sleet" ||
    iconNO == "heavysleetandthunder" ||
    iconNO == "sleetshowersandthunder" ||
    iconNO == "heavysleetshowersHeavy" ||
    iconNO == "lightssleetshowersandthunder" ||
    iconNO == "sleetandthunder" ||
    iconNO == "lightsleetandthunder" ||
    iconNO == "heavysleetshowersandthunder" ||
    iconNO == "sleetshowers" ||
    iconNO == "heavysleet"
  ) {
    iconBadge = "sleet";
...
function solarcalc(lat, localTimeMoment) {
  ...
  declanationOfTheSun = Math.asin(
    -0.39795 *
      Math.cos(
        (2.0 * Math.PI * (numberOfDaysSinceFirstOfJanuary + 10.0)) / 365.0
      )
  );
  ...
  sinSunHeight =
    sinSunPosition +
    cosSunPosition *
      Math.cos((2.0 * Math.PI * (numberOfMinutesThisDay + 720.0)) / 1440.0) +
    0.08;
  sunCorrection =
    1370.0 * (1.0 + 0.033 * Math.cos(2.0 * Math.PI * dayNumberOfYear));

  if (sinSunHeight > 0.0 && Math.abs(0.25 / sinSunHeight) < 50.0) {
    ghiSolarClearSki =
      sunCorrection * sinSunHeight * Math.exp(-0.25 / sinSunHeight);
  } else {
    ghiSolarClearSki = 0;
  }
...
function mode2(arr) {
  ...
  const nMap2 = nMap.filter(
    (e) => e.key !== "" && e.key !== null && e.key !== undefined
  );
  nMap2.sort((e1, e2) => e2.frequency - e1.frequency);
  return nMap2;
}

function badgeGeneral(
  isDay,
  isNight,
  sunnyDayBadge,
  cloudyBadge,
  ...
  function UTFC() {
    chrome.storage.local.get(
      ["setSettingFC", "setSettingUT", "TimeFormat"],
      function (data) {
