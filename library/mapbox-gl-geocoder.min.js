      ...
      3: [
        function (e, t, n) {
          ...
          var i = e("suggestions"),
            ...
            p = e("./localization"),
            f = e("subtag");
          const d = { FORWARD: 0, LOCAL: 1, REVERSE: 2 };
          (r.prototype = {
            options: {
              zoom: 16,
              flyTo: !0,
                    ...
                    (t = s({}, r, this.options.flyTo)),
                      e.center
                        ...
                        : e.geometry &&
                          ...
                          (t.center = e.geometry.coordinates),
            ...
            _requestType: function (e, t) {
              const n = /^[ ]*(-?\d+\.?\d*)[, ]+(-?\d+\.?\d*)[ ]*$/;
              return e.localGeocoderOnly
                ? d.LOCAL
                : e.reverseGeocode && n.test(t)
                ? d.REVERSE
                : d.FORWARD;
            },
              ...
              var i = this,
                o = n.reduce(function (e, t) {
                  ...
                  ["countries", "types", "language"].indexOf(t) > -1
                    ? (e[t] = i.options[t].split(r))
                    : (e[t] = i.options[t]);
                  const n =
                    "number" == typeof i.options[t].longitude &&
                    "number" == typeof i.options[t].latitude;
                  if ("proximity" === t && n) {
                  ...
                  .then(
                    function (t) {
                      ...
                      return (
                        ...
                        (r.features = r.features ? i.concat(r.features) : i),
                        this.options.externalGeocoder
                          ? ((o =
                              this.options.externalGeocoder(e, r.features) ||
                              []),
                            o.then(
                              function (e) {
                                return (
            ...
            setMinLength: function (e) {
              return (
                ...
                this._typeahead && (this._typeahead.options.minLength = e),
                this
              );
            },
            getLimit: function () {
