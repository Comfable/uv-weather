            ...
            _geocode: function (e) {
              ...
              return (
                this.options.localGeocoder &&
                  ((a = this.options.localGeocoder(e)) || (a = [])),
                t.then(
                  function (e) {
                ...
                t.catch(
                  function (e) {
                    (this._loadingEl.style.display = "none"),
                      a.length && this.options.localGeocoder
                        ? ((this._clearEl.style.display = "block"),
                          this._typeahead.update(a))
                        : ((this._clearEl.style.display = "none"),
                          (this._typeahead.selected = null),
                          this._renderError()),
                      this._eventEmitter.emit("results", { features: a }),
        ...
        function (e, t, n) {
          (function (e) {
            function n(e, t, n) {
              ...
              function h(e) {
                return (b = void 0), T && m ? i(e) : ((m = y = void 0), v);
              }
              function p() {
